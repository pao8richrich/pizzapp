...
import TheTotalPizzas from '../interfaces/renderProps/TheTotalPizzas.js';

const PizzaCounter = ({ sizeSliceHandler,counter,slice,totalPizza,countHandler,sliceHandler,clearHandler,averageHandler,size}) => {
